module WistiaActiveResource
  ...
  class Errors
    ...
    def from_json(json)
      array = WistiaActiveSupport::JSON.decode(json)['errors'] rescue []
      from_array array
    end
  ...
  # Base#save to rescue WistiaActiveResource::ResourceInvalid exceptions and parse the errors returned
  ...
  module Validations
    ...
    def save_with_validation
      ...
      when WistiaActiveResource::Formats[:json]
