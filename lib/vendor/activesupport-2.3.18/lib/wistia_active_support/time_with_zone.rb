...
module WistiaActiveSupport
  ...
  #
  # See TimeZone and WistiaActiveSupport::CoreExtensions::Time::Zones for further documentation for these methods.
  #
  ...
  #   t.is_a?(Time)                         # => true
  #   t.is_a?(WistiaActiveSupport::TimeWithZone)  # => true
  class TimeWithZone
    include Comparable
    ...
    #
    # ISO 8601 format is used if WistiaActiveSupport::JSON::Encoding.use_standard_json_time_format is set.
    #
    # ==== Examples
    #
    #   # With WistiaActiveSupport::JSON::Encoding.use_standard_json_time_format = true
    #   Time.utc(2005,2,1,15,15,10).in_time_zone.to_json
    #   # => "2005-02-01T15:15:10Z"
    #
    #   # With WistiaActiveSupport::JSON::Encoding.use_standard_json_time_format = false
    #   Time.utc(2005,2,1,15,15,10).in_time_zone.to_json
    #   # => "2005/02/01 15:15:10 +0000"
    def as_json(options = nil)
      if WistiaActiveSupport::JSON::Encoding.use_standard_json_time_format
        xmlschema
      else
    ...
    private
      ...
      def duration_of_variable_length?(obj)
        WistiaActiveSupport::Duration === obj && obj.parts.any? {|p| [:years, :months, :days].include? p[0] }
      end
  end
end
