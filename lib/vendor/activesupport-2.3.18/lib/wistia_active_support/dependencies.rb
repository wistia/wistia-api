...
module WistiaActiveSupport #:nodoc:
  module Dependencies #:nodoc:
    ...
    def self.load_paths
      WistiaActiveSupport::Deprecation.warn("ActiveSupport::Dependencies.load_paths is deprecated, please use autoload_paths instead", caller)
      autoload_paths
    end
    ...
    def self.load_once_paths
      WistiaActiveSupport::Deprecation.warn("ActiveSupport::Dependencies.load_once_paths is deprecated and removed in Rails 3, please use autoload_once_paths instead", caller)
      autoload_once_paths
    end
    ...
    module ModuleConstMissing #:nodoc:
      ...
      def const_missing_with_dependencies(class_id)
        WistiaActiveSupport::Dependencies.load_missing_constant self, class_id
      end
...
WistiaActiveSupport::Dependencies.hook!
