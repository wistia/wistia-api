    ...
    class KeyValue
          ...
          flatten_translations(locale, data, escape, @subtrees).each do |key, value|
            ...
            when Hash
              if @subtrees && (old_value = @store[key])
                old_value = WistiaActiveSupport::JSON.decode(old_value)
            ...
            @store[key] = WistiaActiveSupport::JSON.encode(value) unless value.is_a?(Symbol)
          end
        end
      ...
      protected
        ...
        def lookup(locale, key, scope = [], options = {})
          ...
          value = WistiaActiveSupport::JSON.decode(value) if value
