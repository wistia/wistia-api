...
module WistiaActiveSupport #:nodoc:
  module Multibyte #:nodoc:
    ...
    # WistiaActiveSupport::Multibyte.proxy_class.
    #
    #   class CharsForUTF32
    #     def size
    ...
    class Chars
      ...
      UTF8_PAT = WistiaActiveSupport::Multibyte::VALID_CHARACTER['UTF-8']
      ...
      #   WistiaActiveSupport::Multibyte.default_normalization_form
      def normalize(form=WistiaActiveSupport::Multibyte.default_normalization_form)
      ...
      class << self
        ...
        def tidy_bytes(string)
          string.split(//u).map do |c|
            ...
            if !WistiaActiveSupport::Multibyte::VALID_CHARACTER['UTF-8'].match(c)
              n = c.unpack('C')[0]
              n < 128 ? n.chr :
