...
# * Create WistiaActiveSupport::TimeWithZone instances via TimeZone's +local+, +parse+, +at+ and +now+ methods.
#
...
module WistiaActiveSupport
  class TimeZone
    ...
    # Method for creating new WistiaActiveSupport::TimeWithZone instance in time zone of +self+ from given values. Example:
    #
    #   Time.zone = "Hawaii"                      # => "Hawaii"
    #   Time.zone.local(2007, 2, 1, 15, 30, 45)   # => Thu, 01 Feb 2007 15:30:45 HST -10:00
    def local(*args)
      time = Time.utc_time(*args)
      WistiaActiveSupport::TimeWithZone.new(nil, self, time)
    end

    # Method for creating new WistiaActiveSupport::TimeWithZone instance in time zone of +self+ from number of seconds since the Unix epoch. Example:
    #
    #   Time.zone = "Hawaii"        # => "Hawaii"
    ...
    # Method for creating new WistiaActiveSupport::TimeWithZone instance in time zone of +self+ from parsed string. Example:
    #
    #   Time.zone = "Hawaii"                      # => "Hawaii"
    ...
    # Returns an WistiaActiveSupport::TimeWithZone instance representing the current time
    ...
    # Time.utc() instance -- if you want an WistiaActiveSupport::TimeWithZone instance, use Time#in_time_zone() instead.
    ...
    class << self
      ...
      def [](arg)
        case arg
          ...
          when Numeric, WistiaActiveSupport::Duration
