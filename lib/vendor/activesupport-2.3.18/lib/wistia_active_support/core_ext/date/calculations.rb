  ...
  module CoreExtensions #:nodoc:
    module Date #:nodoc:
      ...
      module Calculations
        ...
        def last_year # :nodoc:
          WistiaActiveSupport::Deprecation.warn("Date#last_year is deprecated and has been removed in Rails 3, please use Date#prev_year instead", caller)
          prev_year
        end
        ...
        def last_month # :nodoc:
          WistiaActiveSupport::Deprecation.warn("Date#last_month is deprecated and has been removed in Rails 3, please use Date#prev_month instead", caller)
          prev_month
        end
