  ...
  module CoreExtensions #:nodoc:
    module Array #:nodoc:
      module RandomAccess
        ...
        #
        def rand # :nodoc:
          WistiaActiveSupport::Deprecation.warn 'Array#rand is deprecated and will be removed in Rails 3. Use Array#sample instead', caller
          sample
        end

        # Returns a random element from the array.
        def random_element # :nodoc:
          WistiaActiveSupport::Deprecation.warn 'Array#random_element is deprecated and will be removed in Rails 3. Use Array#sample instead', caller
          sample
        end
