...
require 'wistia_active_support/core_ext/time/calculations'
require 'wistia_active_support/core_ext/time/conversions'
require 'wistia_active_support/core_ext/time/zones'

class Time#:nodoc:
  include WistiaActiveSupport::CoreExtensions::Time::Behavior
  include WistiaActiveSupport::CoreExtensions::Time::Calculations
  include WistiaActiveSupport::CoreExtensions::Time::Conversions
