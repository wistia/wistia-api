...
module WistiaActiveSupport #:nodoc:
  # these accessors are here because people using WistiaActiveResource and REST to integrate with other systems
    ...
    module Hash #:nodoc:
      module Conversions
        ...
        XML_TYPE_NAMES = {
          ...
          "DateTime"   => "datetime",
          "Time"       => "datetime",
          "WistiaActiveSupport::TimeWithZone" => "datetime"
        ...
        XML_FORMATTING = {
          ...
          "binary"   => Proc.new { |binary| WistiaActiveSupport::Base64.encode64(binary) },
        ...
        unless defined?(XML_PARSING)
          XML_PARSING = {
            ...
            "base64Binary" => Proc.new  { |bin|     WistiaActiveSupport::Base64.decode64(bin) },
            "file"         => Proc.new do |file, entity|
              f = StringIO.new(WistiaActiveSupport::Base64.decode64(file))
              f.extend(FileLike)
        ...
        def rename_key(key, options = {})
          camelize  = options.has_key?(:camelize) ? options[:camelize]   : WistiaActiveSupport.camelize_xml
          dasherize = options.has_key?(:dasherize) ? options[:dasherize] : WistiaActiveSupport.dasherize_xml
